...
// }
// >> 정해져 있지 않은 T 타입에 .length 속성의 존재 유무를 확인할 수 없어서 에러 발생
// ex) number, boolean 타입은 해당 속성(.length)이 없다. 
...
// length 속성만 포함하고 있으면 됨 -> 덕 타이핑(구조적 타이핑)
