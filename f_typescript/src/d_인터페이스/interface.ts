...
// - 컴파일 시점에 타입 체킹을 사용: 다양한 구현체에 동일한 인터페이스 사용하여 일관성과 재사용성 향상
...
// : interface 키워드 사용
// - 인터페이스명은 대문자로 시작
// - 객체의 문법 체계를 모두 사용 가능: 옵셔널, readonly 등
...
// 2) 클래스에서 인터페이스 구현
// : implements 키워드를 사용하여 해당 타입을 가지는 클래스 정의
