...
// cf) 기본 매개변수: 값 전달 O -> 해당 값 / 값 전달 x -> 기본값
...
greet2(50);  // 안녕하세요, 비회원고객님! 50세입니다.
greet2(40, '이승아'); // 안녕하세요, 이승아님! 40세입니다.

// ! 2. 가변 매개변수: 함수 호출 시 인자 수의 고정x, 함수 내부에서 유동적으로 처리
...
// >> 데이터가 지정될 변수가 있는 매개변수 목록들보다 마지막에 위치
...
console.log(findMin(31, 23, 54, 32, 12)); // 12
