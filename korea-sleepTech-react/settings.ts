...
// 프로젝트를 생성할 폴더에서 통합 터미널 열기
// cf) cmd에서 npm -v 확인하기 
// npm 7+)
// npm create vite@latest
// 프로젝트 설정)
// Project name: 프로젝트 폴더명
// Package name: package.json의 "name" 속성값으로 지정 (소문자로 작성)
...
// & React 실행 시 크롬에서 열기
// 제어판 > 프로그램 > 기본 프로그램 > 기본 프로그램 설정
// 설정 > 기본 앱 > 기본 앱 선택 > 웹 브라우저 - Google Chrome 선택
